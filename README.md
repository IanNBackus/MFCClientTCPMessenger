...
The best practice with the CAsyncSocket class involves creating a subclass that inherits CAsyncSocket. This is due to the fact that we must create user-defined windows messages to map our event handlers to (a quirk of how custom events, or should I say "messages", work in MFC). In our example "SocketController" is the subclass in question.
